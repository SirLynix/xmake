...
function _make_targetinfo(mode, arch, target, vcxprojdir)
    ...
    targetinfo.buildcommand = "\"%$(XMakeExecutableFull)\" l private.plugins.xmakevs build \"%$(XMakeConfig)\" " .. vsutils.escape(target:name())
    targetinfo.rebuildcommand = "\"%$(XMakeExecutableFull)\" l private.plugins.xmakevs rebuild \"%$(XMakeConfig)\" " .. vsutils.escape(target:name())
    targetinfo.cleancommand = "\"%$(XMakeExecutableFull)\" l private.plugins.xmakevs clean \"%$(XMakeConfig)\" " .. vsutils.escape(target:name())
...
function make(outputdir, vsinfo)
    ...
    -- init vsinfo
    vsinfo.solution_dir = path.join(outputdir, "xmakevs" .. vsinfo.vstudio_version)
